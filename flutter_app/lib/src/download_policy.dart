...
String normalizeFocusToken(String value) => value.trim().replaceAll(RegExp(r'[^A-Za-z0-9_.:-]'), '').substring(0, value.trim().replaceAll(RegExp(r'[^A-Za-z0-9_.:-]'), '').length.clamp(0, 96));
